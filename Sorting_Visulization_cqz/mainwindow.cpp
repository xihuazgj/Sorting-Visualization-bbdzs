...
{
    ui->setupUi(this);
    this->setWindowTitle(QString("西华大学排序算法可视化系统"));
    ...
    sortName->setFixedWidth(300);           // 初始显示欢迎语
    ...
    sortName->setText("欢迎进入西华大学排序算法可视化程序！");
    ...
    // 给下拉框添加内容
    ui->comboBox_sortingalgorithm->addItem(tr("基数排序  O(N)功能不全     "));            //  Index 0      O(n)
    ui->comboBox_sortingalgorithm->addItem(tr("快速排序  O(NlogN) "));         //  Index 1      O(nlogn)
    ui->comboBox_sortingalgorithm->addItem(tr("归并排序  O(NlogN)功能不全 "));         //  Index 2      O(nlogn)
    ui->comboBox_sortingalgorithm->addItem(tr(" 堆排序   O(NlogN)功能不全 "));         //  Index 3      O(nlogn)
    ui->comboBox_sortingalgorithm->addItem(tr("希尔排序  O(N^1.5) "));         //  Index 4      O(n^1.5)
    ui->comboBox_sortingalgorithm->addItem(tr("插入排序  O(N^2)   "));          //  Index 5      O(n^2)
    ui->comboBox_sortingalgorithm->addItem(tr("冒泡排序  O(N^2)   "));          //  Index 6      O(n^2)
    ui->comboBox_sortingalgorithm->addItem(tr("选择排序  O(N^2)   "));          //  Index 7      O(n^2)
